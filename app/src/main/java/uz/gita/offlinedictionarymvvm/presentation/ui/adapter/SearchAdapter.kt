...
class SearchAdapter : RecyclerView.Adapter<SearchAdapter.DictionaryViewHolder>() {
    var cursor: Cursor? = null
    var query: String? = ""
    private var onClickRememberListener: ((Int, Int, Int) -> Unit)? = null
            ...
            remember.setOnClickListener {
                cursor?.let {
                    ...
                    onClickRememberListener?.invoke(
                        ...
                        it.getInt(it.getColumnIndex("fav")),
                        it.getInt(it.getColumnIndex("id_cat"))
                    )
                }
            }
        }
    ...
    fun setOnClickRememberListener(block: (Int, Int, Int) -> Unit) {
